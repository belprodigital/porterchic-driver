                          ...
                          Container(
                            ...
                            child:Row(
                              children: <Widget>[
                                Container(
                                  margin: EdgeInsets.only(right:10.0),
                                  child:widget.activeOrderList.status>=2 && widget.activeOrderList.pickUpTime.isNotEmpty?Image.asset(ImageAssests.locationIcon,height: 14.0,width: 11.0,):
               ...
               child:  Row(
                 children: <Widget>[
                   ...
                   Expanded(
                     child: RaisedButton(
                         onPressed:(){
                           callStartPickupApi(widget.activeOrderList.sId,widget.activeOrderList.status);
                           Navigator.push(
                               context, CupertinoPageRoute(
                               builder: (context) => MapScreen(receiverLatitude: widget.activeOrderList.status>=2 && widget.activeOrderList.pickUpTime.isNotEmpty?widget.activeOrderList.receiverLatitude:widget.activeOrderList.pickupLatitude,
                               receiverLongitude: widget.activeOrderList.status>=2 && widget.activeOrderList.pickUpTime.isNotEmpty?widget.activeOrderList.receiverLongitude:widget.activeOrderList.pickupLongitude,id: widget.activeOrderList.sId,isForDeliery: widget.activeOrderList.status>=2 && widget.activeOrderList.pickUpTime.isNotEmpty?true:false,isAfterPickUp: false,
                                 mobileNum: widget.activeOrderList.status>=2 && widget.activeOrderList.pickUpTime.isNotEmpty?widget.activeOrderList.receiverMobile:widget.activeOrderList.receiverMobile,)));
                         },
                         elevation: 0.0,
                         padding: EdgeInsets.only(top: 13.0,bottom: 13.0),
                         color: buttonColor,
                         child: CustomtextFields.textFields(
                           ...
                           text: widget.activeOrderList.status>=2 && widget.activeOrderList.pickUpTime.isNotEmpty?startDelivery:startPickUp,
                           fontWeight: FontWeight.w700,
                           fontSize: 16.0,
                         )
                     ),
